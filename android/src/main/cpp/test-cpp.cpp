...
Java_com_madebysr_data_1melody_DataMelodyPlugin_initNative(JNIEnv * env, jobject obj) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_madebysr_data_1melody_DataMelodyPlugin_processCaptureData(JNIEnv *env, jobject thiz, jshortArray data) {
